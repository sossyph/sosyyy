...
func main() {
	...
	if version {
		fmt.Println("SYHDN-VIP", __version__)
		os.Exit(0)
	}
	...
	go func() {
		...
		fmt.Println("\u001B[31mIn use               \u001B[31m║\t\u001B[35m║\tATTACK OK ║\tATTACK ERR")
		for {
